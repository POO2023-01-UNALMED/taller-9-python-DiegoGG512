...
expresion = ""
entrada = StringVar()
pantalla = Label(root, width=19, bg="black", fg="white", borderwidth=0, font=("arial", 18, "bold"), textvariable=entrada, anchor="e")
...
boton_igual.bind("<Button-1>", lambda p: solucionar())
